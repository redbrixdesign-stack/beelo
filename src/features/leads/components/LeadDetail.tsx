// LeadDetail - Detail page for a lead with call history and voice notes
        ...
        {showCallForm && (
          <Card padding="lg" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
            ...
            <div style={{ display: 'flex', gap: 'var(--spacing-sm)' }}>
              <Button onClick={handleAddCall} leftIcon={<CheckCircle size={16} />}>Save Call</Button>
              <Button variant="ghost" onClick={() => setShowCallForm(false)}>Cancel</Button>
            </div>
          </Card>
        )}
